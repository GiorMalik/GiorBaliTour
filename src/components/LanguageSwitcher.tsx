...
export default function LanguageSwitcher() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 z-50 mt-2 w-56 bg-white border border-gray-200 rounded-md shadow-lg max-h-80 overflow-y-auto">
          <div className="py-1">
            {languages.map((language) => (
              <button
                ...
                className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-100 flex items-center gap-3 ${
                  locale === language.code ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-700'
                }`}
              >
